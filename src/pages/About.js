          ...
          <div class="row gy-4 justify-content-center">
            <div class="col-lg-3 col-md-6">
              <div class="feature-card">
                ...
                <p class="box-text">
                  Stay updated with the latest news, events, and impact stories
                  from our organization. Subscribe to our newsletter.
                </p>
        ...
        <div class="container">
          <div class="title-area text-center">
            <span class="sub-title after-none before-none">
              <i class="far fa-heart text-theme"></i> Our Volunteer
            </span>
            ...
            <div class="counter-card">
              <div class="media-body">
                <h2 class="box-number text-white">
                  <span class="counter-number">15</span>k
            ...
            <div class="col-lg-4 col-md-6 process-card-wrap">
              <div class="process-card">
                ...
                <div class="box-content">
                  ...
                  <p class="box-text">
                    To inform and engage potential donors and supporters about
                    the charity’s mission and the cause it supports. Utilize
              ...
              <div class="process-card">
                ...
                <div class="box-content">
                  ...
                  <p class="box-text">
                    ...
                    that accepts multiple payment methods and allows for both
            ...
            <div class="col-lg-4 col-md-6 process-card-wrap">
              <div class="process-card">
                ...
                <div class="box-content">
                  ...
                  <p class="box-text">
                    Allocate funds to specific projects and initiatives that
                    align with the charity’s mission, ensuring that resources
                    ...
                    <div class="swiper-slide">
                      <div class="testi-card">
                        <p class="box-text">
                          ...
                          campaigns. Whether it's a fundraising gala, a charity
                          run, or a community outreach program, there are plenty
                          of ways to get involved and support our cause. Check
                          our event calendar for details. We prioritize your
                          security. Our donation process uses the latest
                          encryption technology to protect your personal and
                          financial information. Donate with confidence knowing”
                        </p>
                    ...
                    <div class="swiper-slide">
                      <div class="testi-card">
                        <p class="box-text">
                          ...
                          to get involved and support our cause. Check our event
                          calendar for details. We prioritize your security.”
                        </p>
